...
// and returns an [*ObjectFS] whose Root field can be passed to [fs.Mount].
package ocflfuse
...
// NewObjectFS resolves an OCFL object version and returns an [*ObjectFS]
// ready to be mounted as a FUSE filesystem.
//
